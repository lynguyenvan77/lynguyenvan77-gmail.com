...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Location = System::Drawing::Point(38, 32);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(38, 29);
			...
			this->textBox1->Size = System::Drawing::Size(114, 35);
			...
			this->panel1->Location = System::Drawing::Point(0, 636);
			this->panel1->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->panel1->Name = L"panel1";
			this->panel1->Size = System::Drawing::Size(1395, 170);
			...
			this->btnHome->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnHome->Location = System::Drawing::Point(630, 45);
			this->btnHome->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btnHome->Name = L"btnHome";
			this->btnHome->Size = System::Drawing::Size(146, 69);
			...
			this->txtAns->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->txtAns->Location = System::Drawing::Point(82, 32);
			this->txtAns->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->txtAns->Name = L"txtAns";
			this->txtAns->Size = System::Drawing::Size(96, 35);
			...
			this->btnResult->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnResult->Location = System::Drawing::Point(630, 491);
			this->btnResult->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->btnResult->Name = L"btnResult";
			this->btnResult->Size = System::Drawing::Size(146, 72);
			...
			this->txtPoint->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->txtPoint->Location = System::Drawing::Point(250, 268);
			this->txtPoint->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->txtPoint->Name = L"txtPoint";
			this->txtPoint->Size = System::Drawing::Size(97, 28);
			...
			this->pictureBox1->Size = System::Drawing::Size(1395, 636);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(158, 268);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(73, 29);
			...
			this->txtValue1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 25.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->txtValue1->Location = System::Drawing::Point(327, 322);
			this->txtValue1->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->txtValue1->Name = L"txtValue1";
			this->txtValue1->Size = System::Drawing::Size(179, 59);
			this->txtValue1->TabIndex = 43;
			this->txtValue1->TextChanged += gcnew System::EventHandler(this, &Tru::txtValue1_TextChanged);
			// 
			// txtValue2
			// 
			...
			this->txtValue2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 25.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->txtValue2->Location = System::Drawing::Point(690, 322);
			this->txtValue2->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->txtValue2->Name = L"txtValue2";
			this->txtValue2->Size = System::Drawing::Size(183, 59);
			...
			this->txttong->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 25.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->txttong->Location = System::Drawing::Point(1051, 321);
			this->txttong->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->txttong->Name = L"txttong";
			this->txttong->Size = System::Drawing::Size(99, 59);
			...
			this->button1->Location = System::Drawing::Point(534, 321);
			this->button1->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(128, 70);
			...
			this->button2->Location = System::Drawing::Point(908, 321);
			this->button2->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(104, 70);
			...
			this->ClientSize = System::Drawing::Size(1395, 806);
...
private: System::Void btnResult_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (ans != 0) {
		...
		if (test == tong) {
			...
			txttong->Text = "";
			SoundPlayer^ sp1 = gcnew SoundPlayer("C://mysql//mysql//1.wav");
			sp1->Load();
			sp1->PlaySync();
		}
		else {
			...
			txttong->Text = "";
			SoundPlayer^ sp = gcnew SoundPlayer("C://mysql//mysql/123.wav");
			sp->Load();
			sp->PlaySync();
